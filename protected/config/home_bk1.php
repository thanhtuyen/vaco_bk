    ...
    'components' => array(
      ...
      'urlManager'=>array(
        ...
        'rules'=>array(
          	...
          	'<language:(vi|en)>/<id:\d+>/<title:.*?>' => array('Detailmenu/view', 'urlSuffix' => '/', 'caseSensitive' => false),
  
          	'<language:(vi|en)>/<id:\d+>/<name:.*?>' => array('News/list', 'urlSuffix' => '/', 'caseSensitive' => false),
  			'<language:(vi|en)>/<id:\d+>/<id_detail:\d+>/<name:.*?>/<name_detail:.*?>' => array('News/view', 'urlSuffix' => '/', 'caseSensitive' => false),
  
          	'<language:(vi|en)>/<id:\d+>/<nameimage:.*?>' => array('Detailmenuimage/list', 'urlSuffix' => '/', 'caseSensitive' => false),
  			'<language:(vi|en)>/<id:\d+>/<id_detail:\d+>/<nameimage:.*?>/<nameimage_detail:.*?>' => array('Detailmenuimage/new', 'urlSuffix' => '/', 'caseSensitive' => false),
