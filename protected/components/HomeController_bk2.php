...
/*public function getUrl($action, $id, $title)
  ...
  public function getUrlDetail($action, $id, $title)
  {
    return Yii::app()->createUrl($action, array(
      'id' => $id,
      'title' => $title,
  ...
  public function getUrlNews($action, $id, $name, $id_detail='', $name_detail='')
  {
  	if($id_detail != '' && $name_detail != ''){
  		return Yii::app()->createUrl($action, array(
	      	'id' => $id,
	    	'id_detail' => $id_detail,
	      	'name' => $name,
  ...
  public function getUrlMenuImage($action, $id, $nameimage, $id_detail='', $nameimage_detail='')
  {
	if($id_detail != '' && $name_detail != ''){
		return Yii::app()->createUrl($action, array(
	      	'id' => $id,
			'id_detail' => $id_detail,
	      	'nameimage' => $nameimage,
			'nameimage_detail' => $nameimage_detail,
	      //'lang' => Yii::app()->language,
	    ));
	} else {
	    return Yii::app()->createUrl($action, array(
